...
try
{
   ...
   builder.Services.Configure<StripeSettings>(builder.Configuration.GetSection("StripeSettings"));
    ...
    builder.Services.AddScoped(typeof(ITastingReservationRepository), typeof(TastingReservationRepository));
    builder.Services.AddScoped(typeof(ITastingPackageRepository), typeof(TastingPackageRepository));
